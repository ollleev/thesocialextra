...
Node.js 24.12 ou supérieur. Aucune dépendance npm à installer. `node:sqlite` est encore expérimental dans la version 24.13 vérifiée.
...
- Conversations textuelles privées, blocage et signalements. Conservation jusqu’à sept jours après expiration publique, sauf suppression ou modération.
...
Les identités, autorisations de travail et compétences ne sont pas vérifiées par ce logiciel. Vocaux, photos et vidéos ne font pas partie de cette version publiée du code.
